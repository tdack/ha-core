...
from homeassistant.components.renogy_gateway.api.models import (
    FieldSpec,
    RenogyDevice,
    TokenSet,
)
from homeassistant.components.renogy_gateway.const import (
    CONF_DEVICE_UUID,
    CONF_GATEWAY_ID,
    CONF_GATEWAY_NAME,
    CONF_REFRESH_TOKEN,
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "homeassistant.components.renogy_gateway.async_setup_entry",
        return_value=True,
    ) as mock_setup:
        yield mock_setup

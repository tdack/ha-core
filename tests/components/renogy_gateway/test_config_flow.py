...
from homeassistant.components.renogy_gateway.api.auth import (
    RenogyAuthError,
    RenogyConnectionError,
)
from homeassistant.components.renogy_gateway.api.models import GatewayInfo
from homeassistant.components.renogy_gateway.const import DOMAIN
...
def mock_auth_and_rest() -> Generator[tuple]:
    ...
    with (
        patch(
            "homeassistant.components.renogy_gateway.config_flow.RenogyAuth"
        ) as mock_auth_cls,
        patch(
            "homeassistant.components.renogy_gateway.config_flow.RenogyREST"
        ) as mock_rest_cls,
    ):
